...
class LedgerProcessor extends BaseProcessor
{
	...
	function __construct(){
		// echo " [LedgerProcessor Cunst. Balance Sheet]--";
	}
	...
	{	
		...
		else
		{
			...
			else
			{
				...
				$businessResult = $buisnessLogic->validateLedgerData($tRequest["company_id"],$tRequest["ledger_name"],$tRequest["contact_no"]);  // Change by Farhan Shaikh
			}
